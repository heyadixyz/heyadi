...
export default function Portfolio() {
  // Create separate state for each project's details visibility
    ...
    <div className="container">
      <nav className="nav">
        <ul className="flex justify-center space-x-6">
          ...
          <li><Link href="#projects" className="text-blue-500 hover:underline">POW</Link></li>
          <li><Link href="#" className="text-blue-500 hover:underline">Resume</Link></li>
          <li><Link href="#" className="text-blue-500 hover:underline">Blogs</Link></li>
        </ul>
      </nav>

      <div className="content">
        <section className="mb-8">
          <h1 className="text-2xl font-bold mb-4">hey, i'm aditya 👋</h1>
          <p className="mb-2">
        ...
        <section id="projects" className="mb-8">
          <h2 className="text-xl font-bold mb-4">projects i've worked on or am currently working on</h2>
          {projects.map((project, index) => (
            <div key={index} className="project mb-4 last:mb-0">
              <div className="flex items-start">
                <div className="w-12 h-12 bg-gray-200 rounded-full mr-4 flex-shrink-0" aria-hidden="true"></div>
                  ...
                  {project.details && (
                    <>
                      ...
                      >
                        ...
                        {openStates[index] ? <ChevronUp className="ml-1" /> : <ChevronDown className="ml-1" />}
                      </button>
                      {openStates[index] && (
                        <div className="mt-2">
                          <p>{project.details}</p>
        ...
        <footer className="text-center mt-8">
          ...
          <a href="mailto:hello@sharie.xyz" className="text-blue-500 mb-6 inline-block">aditya03officialny@gmail.com</a>
