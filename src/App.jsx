...
function App() {
  ...
  const backgroundImagePath = "/background.svg";
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-white text-black">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <h1 className="text-4xl font-bold mb-2 flex items-baseline">
          <img src="/hammer.svg" alt="Hammer and Wrench" className="w-10 h-10 mr-2" />
          Still Building
        ...
        <div className="flex flex-col sm:flex-row items-baseline space-y-4 sm:space-y-0 sm:space-x-6">
          <a href="https://x.com/heyadixyz" className="flex items-center text-gray-700 hover:text-black">
            <img src="/xlogo.svg" alt="Twitter" className="w-6 h-6 mr-2" />
            <span>heyadixyz</span>
          </a>
          <a href="https://linkedin.com/in/heyadixyz" className="flex items-center text-gray-700 hover:text-black">
            <img src="/linkedinlogo.svg" alt="LinkedIn" className="w-6 h-6 mr-2" />
            <span>heyadixyz</span>
          </a>
          <a href="https://github.com/heyadixyz" className="flex items-center text-gray-700 hover:text-black">
